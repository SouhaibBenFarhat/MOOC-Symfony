...
(function($) {
    ...
    $.ownage.Loader = function(el, params, selector, number) {
        ...
        base.preloadImages = function() {
            var images = [
               context+'/resources/images/ownageLoader/loader1.gif',
               context+'/resources/images/ownageLoader/loader2.gif',
               context+'/resources/images/ownageLoader/loader3.gif',
               context+'/resources/images/ownageLoader/loader4.gif',
               context+'/resources/images/ownageLoader/loader5.gif',
               context+'/resources/images/ownageLoader/loader6.gif',
               context+'/resources/images/ownageLoader/loader7.gif',
               context+'/resources/images/ownageLoader/check.gif',
               context+'/resources/images/ownageLoader/send.gif'
            ];
    ...
    $.ownage.Loader.defaultOptions = {
        image: context+'/resources/images/ownageLoader/loader1.gif',
        style: 1,
        context: 'body',
        modal: true,
        fadeInTime: 300,
